  ...
  build: function () {
    ...
    if (this.THUMBOR_SECURITY_KEY) {
      ...
      return {
        operation: operation,
        key: key,
        server: this.THUMBOR_URL_SERVER,
        image: this.imagePath,
        full: this.THUMBOR_URL_SERVER + '/' + key + '/' + operation + this.imagePath
      }
      ...
      return {
        ...
        server: this.THUMBOR_URL_SERVER,
        image: this.imagePath,
        full: this.THUMBOR_URL_SERVER + '/unsafe/' + operation + this.imagePath
      }
    }
